    ...
    content: [
      {
        ...
        answer:
          "Most older adults can exercise safely.Talk with vour doctor first if you are not sure if exercise is safe for you or if you have a medical condition that is not well controlled",
      },
      {
        question: "Where do I start?",
        answer:
          "Start slowly with activities that you feel comfortable doing. This can help you avoid getting hurt. Do activities that you enjov and that fit into your daily life. Consider joining a gym or working with a certified personal fitness trainer",
        youtube: true,
        video: "https://www.youtube.com/embed/37UhELFvPec",
      },
      {
        question: "When should I call my Doctor?",
        answer:
          "If vou have pain for more than one or two davs after exercise, you should talk to your doctor. Stop exercising rignt away and talk to your doctor if you have any of these symptoms:",
        youtube: true,
        video: "https://www.youtube.com/embed/iNxETz4R5YQ?start=26",
      },
    ],
  },
  {
...
export const { increIndex, decreIndex, changeLike } = lessonsSlice.actions;
